package com.lyq.blog.utils.string;
 ...
 * @author 林义清
 */
public final class MyStringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static String getReplaced(String str, List<String> beforeList, String after) {
        ...
        if (MyStringUtils.isNotBlank(result)) {
            for (String before : beforeList) {
                result = MyStringUtils.replace(result, before, after);
            }
        }
        return result;
    }
